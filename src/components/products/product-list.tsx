...
const ProductList = (list: any) => {
  ...
  const rowExpandable = (record: any) => record?.variation_options?.length > 0 &&  record?.variation_options[0].name!="DUMMY" ;
          ...
          <table>
            <tbody>
              {record.variation_options.map((option: any, index: any) => (
                <tr key={index} className="w-full grid grid-cols-12">
                  ...
                  <td className='col-span-4 flex items-center' style={{ fontFamily: 'poppins' }}><span className="">{option.name}</span></td>
                  <td className='col-span-2 flex  items-center' style={{ fontFamily: 'poppins' }}><span className="pl-[120px] w-44">{option.sub_sku}</span></td>
                  <td className='col-span-3 flex items-center' style={{ fontFamily: 'poppins' }}><span className="pl-10 w-28">{list.BusinesDetails.symbol+' '+option.default_purchase_price}</span></td>
