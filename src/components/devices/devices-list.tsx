...
const ProductList = (list: any) => {
  ...
  const columns = [
    ...
    {
      title:<span style={{fontFamily:"poppins"}}>{t('table:table-item-license-code')}</span>,
      ...
      render: (licence_code: any) => (
        <span className="whitespace-nowrap" style={{fontFamily:"poppins"}}>{licence_code}</span>
      ),
    },

    {
      title: <span style={{fontFamily:"poppins"}}>{t('table:table-item-last-invoice-no')}</span> ,
      className: 'cursor-pointer',
      ...
      render: (last_invoice_no: any) => (
        <span className="whitespace-nowrap" style={{fontFamily:"poppins"}}>{last_invoice_no}</span>
      ),
    },
    {
      title: <span style={{fontFamily:"poppins"}}>{t('table:table-item-invoice-sequence')}</span> ,
      className: 'cursor-pointer',
      ...
      render: (invoice_sequence: any) => (
        <span className="whitespace-nowrap" style={{fontFamily:"poppins"}}>{invoice_sequence}</span>
      ),
    },
    // {
    //   title: 'Status',
