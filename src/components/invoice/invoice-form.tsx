    ...
    <div className="container m-auto grid gap-4 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-8">
      <div className="sm:col-span-2 md:col-span-3 lg:col-span-5">
        <Card className="w-full ">
          ...
          {cardItemDiv && (
            <div className="flex items-center border-b border-solid border-border-200 border-opacity-75 py-4 px-4 sm:px-6 text-sm ">
              ...
              <span className="font-bold text-heading ms-auto mt-5">00:00</span>
          ...
          <div className="flex justify-between">
            <div
              ...
              className="p-3 rounded w-full border-2 border-black text-white hover:bg-white hover:text-black text-center text-sm mt-3 cursor-pointer mr-2 bg-accent"
            >
              {t('form:add-new-invoice')}
              {/* Add new invoice item */}
            </div>
            {/* <div
              onClick={addCustomProduct}
              className="p-3 rounded w-full border-2 border-black text-center hover:bg-black hover:text-white text-sm mt-3 cursor-pointer ml-2"
            >
              Add custom product
            </div> */}
          </div>
        ...
        <Card className="mt-5 w-full">
          ...
          <div className="mb-3 flex justify-between">
            <div className="text-sm">{t('form:vat')}</div>
            <div className="text-sm">
