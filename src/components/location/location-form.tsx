...
export default function CreateOrUpdateTypeForm(initialValues: any) {
  ...
  useEffect(() => {
...

    {
      initialValues.initialValues &&
        ...
        // setProductIdList(initialValues?.initialValues?.featured_products);
        // setProductIdInitial(initialValues?.initialValues?.featured_products);
  ...
  const handleFeatureProduct = (e) => {
    ...
    // console.log(productIdInitial,'idlist');
    // let newValue=productIdInitial.concat(value)

    //  {newValue &&  setProductIdList(newValue)}
  };
