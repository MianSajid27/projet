  ...
  const onSubmit = (values: FormValues) => {
    ...
    let newFooterText = '';
    {
      values.footer_text != null
        ? (newFooterText = values.footer_text)
        : (newFooterText = '');
    }
    let footerLine2 = '';
    {
    ...
    form.append('footer_text', newFooterText);
        ...
        <Card className="w-full sm:w-8/12 md:w-2/3">
          <div className="mb-5">
            ...
            <Switch
              ...
              className={`${
                showProduct ? 'bg-accent' : 'bg-gray-300'
            ...
            >
              ...
              <span
                className={`${
                  showProduct ? 'translate-x-6' : 'translate-x-1'
      ...
      <div className="my-5 flex flex-wrap sm:my-8">
        ...
        <Card className="w-full sm:w-8/12 md:w-2/3">
          <Input
            ...
            error={t(errors.footer_text?.message!)}
            variant="outline"
            className="mb-5"
          />
          <Input
        ...
        <Card className="w-full sm:w-8/12 md:w-2/3">
          <div className="mb-5">
            ...
            <Switch
              ...
              className={`${
                showLogo ? 'bg-accent' : 'bg-gray-300'
              } relative inline-flex h-6 w-11 items-center rounded-full focus:outline-none`}
              dir="ltr"
            >
              <span className="sr-only">Enable </span>
