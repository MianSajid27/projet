...
export default function CustomFeildFrom(initialValues: any) {
  ...
  useEffect(() => {
     const isStatus=initialValues.initialValues?.is_mandatory == 1 ?true:false
setStatus(isStatus)
...
setDataName(isData)
  ...
  const onSubmit = (values: FormValues) => {
    let form = {
      ...
      ref_id: initialValues.initialValues ? initialValues.initialValues.ref_id : query.customId 
    };
