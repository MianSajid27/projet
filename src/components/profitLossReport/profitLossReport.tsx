...
const UnitList = (list: any) => {
  ...
  useEffect(() => {
    console.log('start Date1', startDate1);
  ...
  const [categories, setCategories]: [Categories, any] = useState({
    Profit_product: [
      {
        status: t('form:profit'),
        key: 'product',
      },
    ],
    Profit_category: [
      {
        status: t('form:categories'),
        key: 'category',
      },
    ],
    Profit_brand: [
      {
        status: t('form:brands'),
        key: 'brand',
      },
    ],
    Profit_location: [
      {
        status: t('form:locations'),
        key: 'location',
      },
    ],
    Profit_invoice: [
      {
        status: t('form:invoice'),
        key: 'invoice',
      },
    ],
    Profit_date: [
          ...
          <div id="print-content" ref={tableRef}>
            <div className="flex">
              <Card className="mt-5 mb-3 mr-3 sm:w-8/12 md:w-2/3">
                ...
                >
                  <div className=" sm:w-8/12 md:w-2/3">
                    ...
                    <p style={{ fontSize: '10px' }}>({t('form:by-purchase-price')}): </p>
                  </div>
                  <div className="sm:w-8/12 md:w-2/3">
                    <p style={{ float: 'right' }}>
                ...
                >
                  <div className=" sm:w-8/12 md:w-2/3">
                    <p>{t('form:opening-stock')}</p>
                    <p style={{ fontSize: '10px' }}>({t('form:by-sale-price')}): </p>
                  </div>
                  <div className="sm:w-8/12 md:w-2/3">
                    <p style={{ float: 'right' }}>
                ...
                >
                  <div className=" sm:w-8/12 md:w-2/3">
                    ...
                    <p style={{ fontSize: '10px' }}>({t('form:Exc')}) </p>
                  </div>
                  <div className="sm:w-8/12 md:w-2/3">
                    <p style={{ float: 'right' }}>
                ...
                >
                  <div className=" sm:w-8/12 md:w-2/3">
                    <p>{t('form:total-purchase-shipping')}: </p>
                  </div>
                  <div className="sm:w-8/12 md:w-2/3">
                    <p style={{ float: 'right' }}>
                      {parseFloat(
              ...
              <Card className="mt-5 mb-3 sm:w-8/12 md:w-2/3">
                ...
                >
                  <div className=" sm:w-8/12 md:w-2/3">
                    <p>{t('form:total-stock-recovered')}:</p>
                  </div>
                  <div className="sm:w-8/12 md:w-2/3">
                    <p style={{ float: 'right' }}>
              ...
              <div className="flex p-3" style={{ backgroundColor: '#fafafc' }}>
                <div className=" sm:w-8/12 md:w-2/3">
                  ...
                  <p style={{ fontSize: '10px' }}>
                    ({t('form:total-sell-price-purchase-price')}){' '}
                  </p>
                </div>
                <div className="sm:w-8/12 md:w-2/3">
                  <p>
          ...
          >
            {Object.values(categories).map((category: any) => (
              <Tab
                ...
                className={({ selected }) =>
                  classNames(
                    'w-auto p-2 m-3 rounded-lg py-2.5 pr-2 text-sm font-medium leading-5 text-blue-700',
