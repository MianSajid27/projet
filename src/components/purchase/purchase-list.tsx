...
console.log(list,'lsitlist');
  ...
  const columns = [
    {
      title:<span className="flex justify-center align-item-center" style={{fontFamily:'poppins'}}>{t('table:table-item-name')}</span> ,
      ...
      render: (name: any, row: any) => (
        <span className="cursor-pointer whitespace-nowrap flex justify-center align-item-center" style={{fontFamily:'poppins'}}>
          {name}
        </span>
      ),
    },
    {
      title:<span  className="flex justify-center align-item-center" style={{fontFamily:'poppins'}}>{t('table:table-item-total')}</span> ,
      className: 'cursor-pointer',
    ...
    {
      title: <span  className="flex justify-center align-item-center" style={{fontFamily:'poppins'}}>{t('table:table-item-date')}</span>,
      className: 'cursor-pointer',
    ...
    {
      title:  <span  className="flex justify-center align-item-center" style={{fontFamily:'poppins'}}>{t('table:table-item-status')}</span>,
      className: 'cursor-pointer',
      dataIndex: 'status',
      key: 'name',
      align: 'center',
      ...
      render: (status: any, row: any) =>
        ...
        <span className="whitespace-nowrap flex justify-center align-item-center" style={{fontFamily:'poppins'}}>{status}</span>
