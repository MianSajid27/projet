...
export default function UpdateTypePage() {
  ...
  const subscriptionColumns = [
    ...
    {
      title: t('form:payment-trancription'),
      className: 'cursor-pointer',
    ...
    <>
      <div className="">
        <div className=" border-b border-dashed border-border-base py-5 sm:py-8">
          <div className="flex justify-between w-full">
            <Card className="w-full mr-2 flex justify-between">
              <div className="">
                <div>
                  <h1 className="font-bold text-sm">{t('form:input-label-business-name')} </h1>
                  <h1 className="font-semibold text-sm text-gray-600">
                    {businessData?.name}
                  </h1>
                </div>
                <div className="mt-3">
                  <h1 className="font-bold text-sm">{t('form:input-label-currency')}</h1>
                  <h1 className="font-semibold text-sm text-gray-600">
            ...
            <Card className="w-full ml-2">
              ...
              <div className="mt-3">
                <h1 className="font-bold text-sm">{t('form:owern')}</h1>
                <h1 className="font-semibold text-sm text-gray-600">
        ...
        <div className="mt-5 mb-5">
          <h1 className="font-bold text-sm mb-5">{t('form:business-location')}</h1>
        ...
        <div className="mt-5 mb-5">
          <h1 className="font-bold text-sm mb-5">{t('common:sidebar-nav-item-users')}</h1>
          <div className="mb-8 overflow-hidden rounded shadow">
            <Table
              //@ts-ignore
              columns={userColumns}
