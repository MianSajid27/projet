    ...
    <Card>
      ...
      <div className="p-2">
        <div className="flex justify-end">
          <ReactToPrint
            trigger={() => <Button className="right-px">Print</Button>}
        ...
        <div ref={tableRef} className="pt-5">
          <div className="flex justify-between">
            <div className="flex flex-col">
              {' '}
              <span className="text-sm text-body">Opening Amount</span>{' '}
              <span className="flex justify-center">
                {Number(shift?.opening_amount).toFixed(2)}
              </span>
            </div>
            <div className="flex flex-col">
              <span className="text-sm text-body">Closing Amounts</span>{' '}
              <span className="flex justify-center">
          ...
          <div className="flex justify-between mt-5 mb-5">
            <div className="flex flex-col">
              {' '}
              <span className="text-sm text-body">Opening Date</span>{' '}
              <span className="flex justify-center">{shift?.created_at}</span>
            </div>
            <div className="flex flex-col">
              <span className="text-sm text-body">Closing Date</span>{' '}
          ...
          <div className="p-2">
            ...
            <div className="flex justify-between  border-b p-2">
              <div className="flex flex-col">
                <div className="font-bold">Credit Note</div>{' '}
              </div>
              <div className="flex flex-col">
            ...
            <div className="flex justify-between  border-b p-2">
              <div className="flex flex-col">
                <div className="font-bold">Net Total</div>{' '}
              </div>
              <div className="flex flex-col">
          ...
          <div className="p-2">
            <h3 className="flex justify-center font-bold">Detail Report</h3>
            <div className="flex justify-between p-2 ">
              <div className="flex flex-col">
