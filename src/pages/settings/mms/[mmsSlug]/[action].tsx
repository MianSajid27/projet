...
import CreateOrUpdateTypeForm from '@/components/mms/mms-form';
...
export default function UpdateTypePage() {
  ...
  useEffect(() => {
    setloadingData(true);
    GetSpecificFunction('/sms-configuration', query.mmsSlug as string).then(
      (result) => {
        console.log(result);
  ...
  return (
    <>
      <div className="flex border-b border-dashed border-border-base py-5 sm:py-8">
        <h1 className="text-lg font-semibold text-heading">{t('Edit MMS')}</h1>
      </div>
